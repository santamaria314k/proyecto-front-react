      ...
      <div className="container-fluid">
        ...
        <div className="row py-3 px-lg-5">
          <div className="col-lg-4">
            <h1>
              <span className="text-light">chats-online</span>{" "}
              <span className="text-primary">Chat-Accesor</span>
            </h1>
          </div>
      ...
      <div className="container-fluid p-0">
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
          <Link to="#" className="navbar-brand d-block d-lg-none">
            <h1 className="m-0 display-5 text-capitalize font-italic text-primary">
              <span className="text-light">TIKETS</span>agendamiento
            </h1>
          </Link>
          <button
            type="button"
          ...
          >
            <div className="navbar-nav mr-auto py-0">
              <Link to="/dashboardAsesor" className="nav-item nav-link">
                Menu Accesor
              </Link>
